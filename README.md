...
| GGUF for reach (llama.cpp / LM Studio) | **done 2026-08-29** — fresh renorm-on REAP re-run → `--no-mtp` convert → Q4_K_M/Q5_K_M/Q6_K/Q8_0, `llama-server`-verified. [`Ttimms/KAT-Coder-V2.5-Dev-REAP-50-GGUF`](https://huggingface.co/Ttimms/KAT-Coder-V2.5-Dev-REAP-50-GGUF) (Ollama's bundled llama.cpp is still too old for `qwen35moe`) |
